...
<div class="container">
    ...
    <p>To confirm the admission, students must submit</p>

    <ul>
        <li>– 4 copy of recent PP size photo</li>
        <li>– Main copy of SSC transcript</li>
        <li>– Photocopy of Parent’s NID Card.</li>
        <li>– Along with the properly filled admission form.</li>
    </ul>
    <p><strong> Students will be admitted for the limited seats.</strong></p>
    <ul>
        <li>DPI - Lab Facilities</li>
        <li>PLC Lab</li>
        <li>Computer Lab</li>
        <li>Software lab</li>
        <li>Hardware Lab</li>
